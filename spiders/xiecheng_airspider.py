# -*- coding: utf-8 -*-
"""
Created on 2021-05-23 08:13:20
---------
@summary:
---------
@author: lscoo
...
class XiechengAirSpider(feapder.AirSpider):
    ...
    def start_requests(self):
        plugin = Plugin(used_for='xiecheng')
        res = plugin.get_tasks_for_air_spider()
        for tasks in res:
            for i in tasks:
                params = {
    ...
    def exception_request(self, request, response):
        ...
        log.info(f"代理池已重置{request.proxies_pool.get()}")
        yield request
    ...
    def end_callback(self):
        ...
        plugin.save_xiecheng_data_to_json_for_air_spider()


if __name__ == "__main__":
    XiechengAirSpider().start()
